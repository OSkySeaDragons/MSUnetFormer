...
weights_name = "BANet_res18_uavid_225"
weights_path = "model_weights/uavid/{}".format(weights_name)
#test_weights_name = "BANet_res18_uavid_225-v2"
#test_weights_name = "BANet_res18_uavid_225-v1"
test_weights_name = "BANet_res18_uavid_225"
