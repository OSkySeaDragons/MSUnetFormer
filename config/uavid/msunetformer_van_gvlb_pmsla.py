...
from geoseg.models.MSUnetFormer_van_gvlb_pmsla import MSUnetFormer_van_gvlb_pmsla
...
weights_name = "MSUnetFormer_van_gvlb_pmsla_tiny_uavid"
weights_path = "model_weights/uavid/{}".format(weights_name)
test_weights_name = "MSUnetFormer_van_gvlb_pmsla_tiny_uavid-v2"
# test_weights_name = "MSUnetFormer_van_gvlb_pmsla_tiny_uavid-v1"
# test_weights_name = "MSUnetFormer_van_gvlb_pmsla_tiny_uavid"
...
#  define the network
net = MSUnetFormer_van_gvlb_pmsla(num_classes=num_classes,pretrained=True)
