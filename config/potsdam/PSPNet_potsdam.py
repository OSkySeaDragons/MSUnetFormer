...
weights_name = "PSPNet_potsdam_res50"
weights_path = "model_weights/potsdam/{}".format(weights_name)
# test_weights_name = "PSPNet_potsdam_res50-v2"
# test_weights_name = "PSPNet_potsdam_res50-v1"
test_weights_name = "PSPNet_potsdam_res50"
...
#  define the network
net = PSPNet(pretrained=True,num_classes=num_classes,downsample_factor=2)
