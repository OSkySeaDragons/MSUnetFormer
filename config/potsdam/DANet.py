...
weights_name = "DANet-r18-potsdam-00"
weights_path = "model_weights/potsdam/{}".format(weights_name)
#test_weights_name = "DANet-r18-potsdam-00-v2"
test_weights_name = "DANet-r18-potsdam-00-v1"
# test_weights_name = "DANet-r18-potsdam-00"
