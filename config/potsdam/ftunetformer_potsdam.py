...
# from geoseg.models.FTUNetFormer import ft_unetformer_small
...
weights_name = "ftunetformer-swin_tiny-768crop-ms-e45"
weights_path = "model_weights/potsdam/{}".format(weights_name)
#test_weights_name = "ftunetformer-swin_tiny-768crop-ms-e45-v2"
test_weights_name = "ftunetformer-swin_tiny-768crop-ms-e45-v1"
#test_weights_name = "ftunetformer-swin_tiny-768crop-ms-e45"
...
#  define the network
net = ft_unetformer_tiny(pretrained=True,num_classes=num_classes,decoder_channels=256)
