...
weights_name = "manet-r18-vaihingen-512-crop-ms-e225"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
#test_weights_name = "manet-r18-vaihingen-512-crop-ms-e225-v2"
# test_weights_name = "manet-r18-vaihingen-512-crop-ms-e225-v1"
test_weights_name = "manet-r18-vaihingen-512-crop-ms-e225"
...
#  define the network
net = MANet(pretrained=True,num_classes=num_classes,backbone_name='resnet18')
