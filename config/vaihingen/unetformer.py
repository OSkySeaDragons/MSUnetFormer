...
weights_name = "unetformer-r18-vaihingen-512-crop-ms-e100"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
#test_weights_name = "unetformer-r18-vaihingen-512-crop-ms-e100-v2"
test_weights_name = "unetformer-r18-vaihingen-512-crop-ms-e100-v1"
# test_weights_name = "unetformer-r18-vaihingen-512-crop-ms-e100"
