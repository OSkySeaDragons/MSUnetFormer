...
from geoseg.models.ABCNet_ys import ABCNet
...
weights_name = "ABCNet-r18-vaihingen-512-crop-ms-e225"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
#test_weights_name = "ABCNet-r18-vaihingen-512-crop-ms-e225-v2"
test_weights_name = "ABCNet-r18-vaihingen-512-crop-ms-e225-v1"
#test_weights_name = "ABCNet-r18-vaihingen-512-crop-ms-e225"
...
#  define the network
net = ABCNet(band=3,n_classes=num_classes)
