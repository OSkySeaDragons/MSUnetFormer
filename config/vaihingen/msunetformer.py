...
weights_name = "MSUnetFormer_tiny_vaihingen_duizhao"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "MSUnetFormer_tiny_vaihingen_duizhao-v2"
#test_weights_name = "MSUnetFormer_tiny_vaihingen_duizhao-v1"
#test_weights_name = "MSUnetFormer_tiny_vaihingen_duizhao"
...
#  define the network
net = MSUnetFormer(num_classes=num_classes,pretrained=True)
