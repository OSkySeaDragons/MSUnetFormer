...
from geoseg.Net.PSPNet.resnet  import resnet50
from geoseg.Net.PSPNet.mobilenetv2 import mobilenetv2
...
class _PSPModule(nn.Module): #2048
    ...
    def forward(self, features):
        ...
        # print("显示维度pyramids",len(pyramids))
        # print("显示维度pyramids", pyramids[0].shape)
        # print("显示维度pyramids", pyramids[1].shape)
        # print("显示维度pyramids", pyramids[2].shape)
        # print("显示维度pyramids", pyramids[3].shape)
        # print("显示维度pyramids", pyramids[4].shape)
...
if __name__ == '__main__':
    ...
    model = PSPNet(pretrained=True,num_classes=2,downsample_factor=2)
    out = model(inputs)
    print(out[0].shape)