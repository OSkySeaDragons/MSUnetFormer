...
def ft_unetformer_tiny(pretrained=True, num_classes=6, freeze_stages=-1, decoder_channels=96,
...
def ft_unetformer_small(pretrained=True, num_classes=6, freeze_stages=-1, decoder_channels=96,
...
def ft_unetformer_base(pretrained=True, num_classes=6, freeze_stages=-1, decoder_channels=256,
